...
import com.example.crudapp.api.BaseCrudController;
...
public class DynamicControllerRegister implements BeanDefinitionRegistryPostProcessor {
    ...
    public void postProcessBeanDefinitionRegistry(BeanDefinitionRegistry registry) throws BeansException {
        ...
        for (BeanDefinition bd : scanner.findCandidateComponents("com.example.crudapp.data")) {
            try {
                ...
                Class<?> controllerClass = new ByteBuddy()
                        ...
                        .name("com.example.crudapp.api.generated." + entityClass.getSimpleName() + "Controller")
                        .annotateType(
